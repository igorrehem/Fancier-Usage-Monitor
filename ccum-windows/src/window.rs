...
const STARTUP_REGISTRY_KEY: &str = "FancierUsageMonitor";
...
pub fn run() {
    ...
    let mutex_name = native_interop::wide_str("Global\\FancierUsageMonitor");
    let _mutex = unsafe {
    ...
    let class_name = native_interop::wide_str("FancierUsageMonitor");
