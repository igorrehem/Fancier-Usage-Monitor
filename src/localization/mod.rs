...
pub struct Strings {
    ...
    // --- Settings window (Task 18) ---
    pub section_appearance: &'static str,
    pub section_font: &'static str,
    pub section_size: &'static str,
    pub section_animations: &'static str,
    pub section_update: &'static str,
    pub section_presets: &'static str,
    pub color_calm: &'static str,
    pub color_attention: &'static str,
    pub color_critical: &'static str,
    pub color_background: &'static str,
    pub color_text: &'static str,
    pub color_divider: &'static str,
    pub frequency_custom: &'static str,
    pub preset_default: &'static str,
    pub preset_glass: &'static str,
    pub preset_neon: &'static str,
    pub preset_minimal: &'static str,
    pub weight_regular: &'static str,
    pub weight_semibold: &'static str,
    pub weight_bold: &'static str,
    pub geometry_height: &'static str,
    pub geometry_corner_radius: &'static str,
    pub geometry_bar_thickness: &'static str,
    pub geometry_label_width: &'static str,
    pub geometry_text_width: &'static str,
    pub geometry_spacing: &'static str,
    pub field_opacity: &'static str,
    pub field_family: &'static str,
    pub field_size: &'static str,
    pub field_weight: &'static str,
    pub field_on: &'static str,
    pub field_speed: &'static str,
    pub field_intensity: &'static str,
    pub field_threshold: &'static str,
    pub field_duration: &'static str,
    pub field_reduce_motion: &'static str,
    pub field_frequency: &'static str,
    pub field_custom_minutes: &'static str,
    pub group_fill: &'static str,
    pub group_shimmer: &'static str,
    pub group_alert_glow: &'static str,
    pub group_fade_slide: &'static str,
